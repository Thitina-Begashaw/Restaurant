    ...
    <div className="bg-[url('./assets/Bg8.jpg')] bg-cover bg-center h-[150vh]">
      <div
        className={`flex flex-row gap-12 font-bold h-28 fixed z-10 ${
          isScrolled ? "bg-black w-lvw h-20 transition-colors duration-300" : "bg-transparent"
        }`}
      >
        <img
          ...
          alt="Restaurant Logo"
        />
        <h3 className={`cursor-pointer hover:text-orange-400 text-5xl ml-40 mt-6 text-orange-400 font-extrabold ${isScrolled ? "mt-3" : "mt-6"}`}>
          Restaurant
        </h3>
