...
import Pic5 from "../assets/verticalLine.jpg";
export default function AboutUs(){
  ...
  <div className=" mt-36">
    ...
    <div className="flex flex-row -mt-16 ml-36 gap-5 mb-20">
    <img className="h-48 w-48" src={Pic3} alt="" />
    <img className="h-64 w-64" src={Pic4}  alt="" />
    </div>
    </div>
    <div className="mr-20">
    <h1 className="text-orange-500  text-5xl font-bold text-center italic ">Welcome to Restaurant </h1>
  ...
  {/* <img className="w-52 h-52" src ={Pic5} alt="" /> */}
  </div>
