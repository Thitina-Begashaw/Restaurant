  ...
  return(
    <div className="bg-[url('./assets/Back3.jpg')] bg-cover bg-center min-h-screen">
      <div className="flex flex-row gap-12 bg-black h-28"> 
        ...
        <h3 className=" cursor-pointer hover:text-orange-400 text-5xl ml-36 mt-6 text-orange-400 font-extrabold">Restaurant</h3>
        <div className="flex flex-row gap-12 text-white items-centers ml-60 mt-10 text-lg ">
        ...
        <button className="flex px-7 py-3 mb-7 -mt-3 bg-orange-500 hover:bg-orange-600 text-white transition duration-300  ">BOOK A TABLE</button>
        </div>
      </div>
    </div>
